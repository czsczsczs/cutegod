...
class mts_post_slider_widget extends WP_Widget {
	...
	public function get_cat_posts( $cat, $slides_num, $show_title, $title_limit ) {
        ...
        ?>
			<div class="slider-widget-container loading">
							...
							<a href="<?php the_permalink() ?>">
                                ...
                                <?php if ($show_title) { ?>
									<div class="flex-caption">
										<h2 class="slider-title"><?php $title = get_the_title();  echo ($title_limit < 1) ? $title : (strlen($title) > $title_limit ? substr($title, 0, $title_limit).'...' : $title); ?></h2>
									</div>
                                <?php } ?>
							</a> 
						</li>
