...
define( 'DB_NAME', 'cutegod_cn' );

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define( 'DB_USER', 'cutegod_cn' );

/** MySQL 資料庫密碼，請更改 "password_here" */
define( 'DB_PASSWORD', 'y3+4H3*gf8' );

/** MySQL 主機位址 */
define( 'DB_HOST', 'gd-mysql-1' );
 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         'BkUL-8a(m&SN7uzEac<HG3r2`sQqEav{U4JwMc0AD{aS]N7vaclQZpzo)DUiFUnr' );
define( 'SECURE_AUTH_KEY',  'N(xHb(J H0k0)#AC^>gw%?iE^399817G7(pwz}^f*{[{OzY!{LPP<?Ss)`YeS3yy' );
define( 'LOGGED_IN_KEY',    '0(v,{j1WsfCN)/`bEUA_2cdKb#<([Uic?2ACv^@tVTjNrYwL(S`}~T[HsFbpy;Vg' );
define( 'NONCE_KEY',        'J>n&lncd75>Bv-0+ji,!i*Ie>R{YHTs([a 5,|N;z<KB<1N&W3nOWd$%0QvFj%Wf' );
define( 'AUTH_SALT',        'ly6!L(>vKEWZ1{/7*i!pb;($U76;n1s.39q:m;#Km,x<|V%7p;n$^DMJ//2RSDo_' );
define( 'SECURE_AUTH_SALT', 'Bkjr-@=Z/Nd#e,%0eR8aY4}1}Fr34uDPH>AY:SaCdFE4+;d7U,R+<6+|^a#vlrqf' );
define( 'LOGGED_IN_SALT',   'Nho}G7R4fqQv`9WTTy7}h:dJv$cVEv<r :<l@u;bmjm3q4s+[o5GrrDSKI.H0~{F' );
define( 'NONCE_SALT',       '2Z}8TM^iOE`/j.n8&+/Nv{3JML})X6vyS E`STl(H(C^{fbFy_SJc*c]WNX]:=&x' );
...
define('DOMAIN_CURRENT_SITE', 'cutegod.cn');
