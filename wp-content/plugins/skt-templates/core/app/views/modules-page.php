...
<div class="sktb-full-page-container">
    ...
    <p><?php esc_attr_e( 'Ready to import WordPress websites all made up using Elementor page builder. Be ready to import those Elementor templates into your existing website or fresh installs. Use the template blocks with your favourite themes whereas if you want to take the full juice out of those templates try SKT free themes. SKT Themes houses more than 291+ exciting designs and have been doling out updates to existing themes as well as fresh designs each year from 2013 and has a customer base from all over the world.', 'skt-templates' ); ?></p>
