...
define( 'DB_NAME', 'poptek.net.demo' );

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define( 'DB_USER', 'poptek_net_demo' );

/** MySQL 資料庫密碼，請更改 "password_here" */
define( 'DB_PASSWORD', 'Maep89Q7T=' );

/** MySQL 主機位址 */
define( 'DB_HOST', 'mo-mysql' );
 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         '8(1]<p&#oZVKaJ:UK;rS%o0Q[x)#rVh_z[V@?BQ&wmOM$h2.a}f!yJ*)P*zEs[yl' );
define( 'SECURE_AUTH_KEY',  'Tbmem16Kc|8#={_}-<a6hSbVcjk*x=iMC;tpMtrQ:|BWS0]xN$,9ph#J0ZYz{j@n' );
define( 'LOGGED_IN_KEY',    '5M;vcl0Bnl$qW~7 4_%`BW!W6NBN)#2^[0uq:&2?PNR8eK.)_ w:w`2,(Zc9DgPZ' );
define( 'NONCE_KEY',        '|9I/~ho9lsHNrV)v=fmkgF-7OOW;@6t;D.P!pHU!tv b/c]3Bj|4dW&e/vyX5YGX' );
define( 'AUTH_SALT',        'A/uLY9kO5zFMfQjmG|-bW:Q2)?s8a*,;F.hbo2`Bog+tz4F6xDo[c-o=Q/EP./Ll' );
define( 'SECURE_AUTH_SALT', '2qYKJtZ%;zgSNG4[rpEi{V{Js_b#${2u-IAk?,@(+E`<L8_(Y-DLo|z4`EIxFsD)' );
define( 'LOGGED_IN_SALT',   'IB_w*B5~b&(FIUQM?:uf: .YjPQ, 7Dkl3oHiU-3nGToqvNPb?21D)UUVYUke|mT' );
define( 'NONCE_SALT',       'l{M!}myX}x0xsu6AfCgPuJo~g:07Z>;el)X@[k3ZU3T|nV9`(U(Cc~9 @?On2i>#' );
