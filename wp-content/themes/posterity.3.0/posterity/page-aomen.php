					...
					?>>
						<div class="formatter">
							...
							<div class="real-content"<?php posterity_schema_args('text'); ?>>
								...
								<div class="cs">
								<ul id="all" class="sitemap-list portfolio recent-work clearfix" style="display:flex;
		flex-wrap: wrap;">
										<?php query_posts('cat=2&showposts=999'); //cat是要调用的分类ID,showposts是需要显示的文章数量 ?>
