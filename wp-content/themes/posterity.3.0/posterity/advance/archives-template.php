            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class('content-box'); ?>>
                <div class="formatter">
                    ...
                    <div class="real-content">
                        ...
                        <div class="left50">
                            <h3><?php echo esc_html__( 'Latest 50 posts', 'posterity' ); ?></h3>
                            <ul class="styled">
                            <?php
                        ...
                        <div class="right50">
                            <h3><?php esc_html_e( 'By months', 'posterity' ); ?></h3>
                            <ul class="styled">
                            <?php
                                wp_get_archives(array(
                                'type'            => 'monthly',
                            ...
                            <h3><?php echo esc_html__( 'Top 10 categories', 'posterity'  ); ?></h3>
                            <ul class="styled">
                            <?php
                            ...
                            <h3><?php echo esc_html__( 'Top 10 tags', 'posterity'  ); ?></h3>
                            <ul class="styled">
                            <?php
                                $tags = get_tags(array(
                                    'orderby'            => 'count',
